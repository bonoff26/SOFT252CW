...
public class MainMenu extends javax.swing.JFrame {
    ...
    private void MainSubmitbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MainSubmitbtnActionPerformed
        ...
        if (!ID.equals("") && !passwordtxt.getText().equals("")) {
            System.out.println(userIDtxt.getText().charAt(0));
            System.out.println(ID);
            char letter = userIDtxt.getText().charAt(0);
            switch (letter) {
                case 'P':
                    if (check(ID, Data.patients)) {
                        ...
                        MessageBox.infoBox("Wrong password", "WRONG INFO");
                        break;
                    }
                case 'D':
                    if(check(ID, Data.doctors)) {
                        Data.currentUserID = ID;
                        this.dispose();
            ...
            MessageBox.infoBox("Enter a valid ID", "WRONG INFO");
        }
